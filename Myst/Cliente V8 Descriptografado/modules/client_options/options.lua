...
function init()
  ...
  interfacePanel = g_ui.loadUI('game')
  optionsTabBar:addTab(tr('Jogo'), interfacePanel, '/images/optionstab/game')  

  consolePanel = g_ui.loadUI('console')
  optionsTabBar:addTab(tr('Console'), consolePanel, '/images/optionstab/console')

  graphicsPanel = g_ui.loadUI('graphics')
  optionsTabBar:addTab(tr('Gr�ficos'), graphicsPanel, '/images/optionstab/graphics')

  optionsButton = modules.client_topmenu.addLeftButton('optionsButton', tr('Options'), '/images/topbuttons/options_hover', toggle)
