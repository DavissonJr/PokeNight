...
function setupButton(widget)
  ...
  widget.onMouseRelease = function(widget, mousePos, mouseButton)
    if mouseButton == MouseRightButton then 
      ...
      menu:addOption(widget.item:getItemId() > 100 and tr('Editar Objeto') or tr('Selecionar objeto'), function() assignItem(widget) end)
      menu:addOption(widget.text:getText():len() > 0 and tr('Editar Texto') or tr('Adicionar Texto'), function() assignText(widget) end)
      menu:addOption(widget.hotkey and tr('Editar Atalho') or tr('Adicionar Atalho'), function() assignHotkey(widget) end)
