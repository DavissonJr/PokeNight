...
function UIPopupMenu:addOption(optionName, optionCallback, shortcut)
    ...
    optionWidget:setId(optionName) -- Thalles Vitor
...
-- Thalles Vitor
function UIPopupMenu:removeOption(optionName, optionCallback, shortcut)
    local optionWidget = self:getChildById(optionName)
