...
defaultComboKeysTable = {
    ...
    [13] = {key = 'PageUp', autoSend = true, itemId = nil, subType = nil, useType = nil, value = 'h1'},
    [14] = {key = 'PageDown', autoSend = true, itemId = nil, subType = nil, useType = nil, value = 'h2'},
...
-- public functions
function init()
   -- zoombutton = modules.client_topmenu.addLeftButton('zoomButton', tr('Alterar ViewMode')..' (Ctrl+.)','/images/topbuttons/zoom', modules.game_interface.nextViewMode)
    hotkeysButton = modules.client_topmenu.addLeftGameToggleButton('hotkeysButton', tr('Atalhos') .. ' (Ctrl+K)',
                                                             '/images/topbuttons/hotkeys_hover', toggle)
