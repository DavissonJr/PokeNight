...
function createMenu(slotId)
    ...
    slotToEdit = slotId
    menu:addOption('Adicionar Objeto', function()
        startChooseItem()
        openObjectAssignWindow()
    end)
    menu:addOption('Adicionar Texto', function()
        openTextAssignWindow()
    end)
    menu:addOption('Editar Atalho', function()
...
function addActionBarPanel()
    local console = modules.game_console.consolePanel
    console:addAnchor(AnchorTop, actionBar:getId(), AnchorBottom)
end

function removeActionBarPanel()
    local console = modules.game_console.consolePanel
    console:addAnchor(AnchorTop, actionBar:getId(), AnchorTop)
end