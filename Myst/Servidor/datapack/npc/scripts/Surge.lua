...
function onCreatureSay(cid, type, msg)
	...
	if msgcontains(msg, 'hi') and focus == 0 and getDistanceToCreature(cid) <= 4 then
		...
		talk_start = os.clock()
		conv = 1
		selfSay("Olá "..getCreatureName(cid)..", meu nome é Surge e sou o líder do ginásio de Vermilion. Como posso ajudá-lo?")
	return true
	end
	...
	if isDuelMsg(msg) and conv == 1 and focus == cid then
		...
		--	selfSay("Você já ganhou minha Insígnia de Boulder, talvez algum outro dia possamos lutar.")
		--	focus = 0
		--return true
		--end
