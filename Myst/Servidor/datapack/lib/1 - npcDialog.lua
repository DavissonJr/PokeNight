...
-- Caixa de Dialogos --
local dialogOpcode_show = 122 -- opcode da janela de dialogos (1)
local dialogOpcode_hide = 123 -- opcode da janela de dialogos (2)
local dialogOpcode_registerBtns = 124 -- opcode da janeal de diaologos (3)
