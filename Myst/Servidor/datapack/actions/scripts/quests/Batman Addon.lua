...
doBroadcastMessage("o "..getCreatureName(cid).." esta tentando fazer a quest Batman ilegalmente")
return true
end
storage = 550982495 -- Storage a cada quest que for criada aumente um numero da storage pra qnd vc pegar o baú de outra quest ñ aparecer que vc já fez.
item = 13264 -- Id do item ira ganhar.
nomeitem = "Batman Addon" -- Nome do item
