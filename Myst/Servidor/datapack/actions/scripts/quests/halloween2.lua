...
doBroadcastMessage("o "..getCreatureName(cid).." esta tentando fazer a quest Halloween Token ilegalmente")
return true
end

storage = 31441565 -- Storage a cada quest que for criada aumente um numero da storage pra qnd vc pegar o baú de outra quest ñ aparecer que vc já fez.
item = 26849 -- Id do item ira ganhar.
nomeitem = "Halloween Token" -- Nome do item
